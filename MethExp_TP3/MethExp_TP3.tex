...
On place dans dans le vase du calorimètre 400gr d'eau à $40^\circ C$. O a donc la capacité thermique du calorimètre qui est:

\begin{equation}
	C = m_{eau}c_{eau} + m_{vase}c_{vase} = 0.4 \times 4185 + 0.0969 \times 897 \approx 1761 J.K^{-1}
\end{equation}

On mesure ensuite la température de l'eau à $40^\circ C$ et on mesure la température du calorimètre toutes les 2 minutes pendant 20 minutes.
...
son logarithme et l'on observe que l'on obtient bien une droite. Notre température suit donc bien une décroissance exponentielle.
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=0.7]{img/Figure_3.png}
	\end{center}
	\label{fig:graph3}
	\caption{Logarithme de la température intérieur en fonction du temps}
\end{figure}
