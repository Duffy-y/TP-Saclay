...
% 	\bibitem{Propagation_incertitude}
% 	Propagation des incertitudes sur addition, produit et puissance, Wikipédia \href{https://fr.wikipedia.org/wiki/Propagation_des_incertitudes#Incertitude_sur_une_addition_ou_une_soustraction}{Lien}
